...
int argument_parser::parse()
{
    ...
    try
    {
        ...
        desc.add_options()
            ...
            ("width,W", boost::program_options::value<int>()->default_value(0), "Width in characters of the output ascii.  If height is not set, aspect ratio will be maintained")
            ("height,H", boost::program_options::value<int>()->default_value(0), "Height in characters of the output ascii. If width is not set, aspect ratio will be maintained")
